...
dependency_graph:
  requires:
    - phase: 03-webfetch-content-pipeline/01
      provides: [src/lib/fetch.ts, src/lib/input.ts::WebFetchInputSchema, src/webfetch.ts, scripts/webfetch.js]
  provides:
...
tech_stack:
  ...
  patterns: [readability-turndown-pipeline, perplexity-summarize-disable-search, content-truncation-100kb]
key_files:
  created:
    - src/lib/content.ts
