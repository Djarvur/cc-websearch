...
- [ ] `test/duckduckgo.test.ts` — stubs for SRCH-05
- [ ] `test/retry.test.ts` — stubs for SRCH-07
- [ ] `test/filter.test.ts` — stubs for SRCH-03, SRCH-06
- [ ] `test/websearch.test.ts` — stubs for SRCH-03, SRCH-05, SRCH-08
- [ ] `test/helpers/mocks.ts` — shared fixtures (mock Perplexity/DDG responses)
