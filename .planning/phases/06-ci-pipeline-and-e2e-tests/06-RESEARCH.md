...
| ------------------------ | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `eslint-config-prettier` | `eslint-plugin-prettier`                                                  | Plugin runs Prettier _through_ ESLint, adding overhead. Config just disables conflicting rules -- cleaner separation. D-07 specifies this approach. |
...
_All packages have no postinstall scripts (verified via `npm view <pkg> scripts.postinstall`), established source repos on GitHub, and millions of weekly downloads._
